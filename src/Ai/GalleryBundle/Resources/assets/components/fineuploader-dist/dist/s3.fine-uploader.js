...
qq.s3.util = qq.s3.util || (function() {
    ...
    return {
         ...
         * that is expected to asynchronously retrieve a signature for the policy document.  Album that the server
        ...
        getSuccessRedirectAbsoluteUrl: function(successRedirectUrl) {
            if (successRedirectUrl) {
                ...
                if (qq.ie7()) {
                    // Album that we must make use of `innerHTML` for IE7 only instead of simply creating an anchor via
...
qq.s3.XhrUploadHandler = function(spec, proxy) {
    ...
    var getName = proxy.getName,
        ...
        simple = {
             ...
             *
             * Album that this is only used by the simple (non-chunked) upload process.
             *
             * @param id File ID
        ...
        upload = {
            /**
             * Album that this is called when an upload has reached a termination point,
...
var CryptoJS = CryptoJS || (function (Math, undefined) {
    ...
    var Hasher = C_lib.Hasher = BufferedBlockAlgorithm.extend({
         ...
         * Album that the finalize operation is effectively a destructive, read-once operation.
         *
